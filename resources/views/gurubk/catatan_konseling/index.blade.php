...
<div class="animate-fadeInUp space-y-6">
    ...
    <div class="flex items-center justify-between flex-wrap gap-3">
        ...
        <button onclick="document.getElementById('modal-tambah-catatan').classList.remove('hidden')"
...
<div id="modal-tambah-catatan"
     class="hidden fixed inset-0 z-50 flex items-center justify-center p-4"
     style="background: rgba(0,0,0,.5); backdrop-filter: blur(4px);"
     onclick="if(event.target===this) this.classList.add('hidden')">

    <div class="rounded-3xl w-full max-w-2xl shadow-2xl relative flex flex-col"
        ...
        <div class="px-6 py-4 flex justify-between items-center flex-shrink-0"
            ...
            <div class="flex items-center gap-2">
                <i class='bx bx-notepad text-xl' style="color: var(--accent-light)"></i>
                <h3 class="font-outfit font-bold text-lg" style="color: var(--text-primary)">Tambah Catatan Konseling</h3>
            </div>
            <button onclick="document.getElementById('modal-tambah-catatan').classList.add('hidden')"
        ...
        <div class="overflow-y-auto flex-1">
            <form action="{{ route('gurubk.catatan-konseling.store') }}" method="POST" class="p-6 space-y-4">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-xs font-medium mb-1.5" style="color: var(--text-muted)">
                            Tanggal sesi <span class="text-red-400">*</span>
                        </label>
                    ...
                    <div>
                        <label class="block text-xs font-medium mb-1.5" style="color: var(--text-muted)">
                            Jenis konseling <span class="text-red-400">*</span>
                        </label>
                ...
                <div>
                    <label class="block text-xs font-medium mb-1.5" style="color: var(--text-muted)">
                        Masalah / topik yang dibahas <span class="text-red-400">*</span>
                    </label>
                    <textarea name="masalah" rows="3"
                              placeholder="Tuliskan masalah atau topik yang disampaikan siswa..."
                              class="w-full text-sm rounded-lg px-3 py-2 outline-none resize-none"
                ...
                <div>
                    <label class="block text-xs font-medium mb-1.5" style="color: var(--text-muted)">
                        Tindakan / intervensi guru BK <span class="text-red-400">*</span>
                    </label>
                ...
                <div>
                    <label class="block text-xs font-medium mb-1.5" style="color: var(--text-muted)">Rencana tindak lanjut</label>
                ...
                <div class="pt-2 flex gap-3">
                    <button type="button"
                            onclick="document.getElementById('modal-tambah-catatan').classList.add('hidden')"
                            class="flex-1 py-2.5 rounded-xl text-sm font-medium transition"
                            style="border: 1px solid var(--border); color: var(--text-secondary)">
                        Batal
                    </button>
                    <button type="submit"
                            class="flex-1 py-2.5 rounded-xl text-sm text-white font-medium transition"
                            style="background: var(--accent)"
                            onmouseover="this.style.background='var(--accent-hover)'"
                            onmouseout="this.style.background='var(--accent)'">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        @if($errors->any() || old('masalah'))
            document.getElementById('modal-tambah-catatan').classList.remove('hidden');
        @endif
    });
