...
<head>
    ...
    <title>Tambah Agenda - Schoolify Modern</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .info-box { background: rgba(99,102,241,0.06); border: 1px solid rgba(99,102,241,0.15); border-radius: 16px; padding: 16px 20px; margin-bottom: 28px; }
        ...
        @media (max-width: 768px) { .sidebar { transform: translateX(-120%); } .main-content { margin-left: 24px; } .form-grid { grid-template-columns: 1fr; } .form-group.full-width { grid-column: span 1; } }
    </style>
</head>
<body>
    <div class="sidebar">
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            <div class="form-header"><h2><i class="fas fa-calendar-plus"></i>Form Tambah Agenda</h2></div>
            <div class="form-body">
                <div class="info-box"><p><i class="fas fa-info-circle"></i> Agenda yang dibuat akan muncul di kalender sesuai target yang dipilih.</p></div>
                <form action="{{ route('admin.agendas.store') }}" method="POST">
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="Contoh: Ujian Tengah Semester" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="start_date" class="form-control" value="{{ old('start_date', $defaultDate) }}" required>
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="location" class="form-control" value="{{ old('location') }}" placeholder="Contoh: Aula Sekolah">
                            @error('location')<p class="error-text">{{ $message }}</p>@enderror
                        </div>
                        <div class="form-group full-width">
                            <label class="form-label"><i class="fas fa-align-left"></i> Deskripsi</label>
                            <textarea name="description" class="form-control" placeholder="Deskripsi atau catatan tambahan">{{ old('description') }}</textarea>
