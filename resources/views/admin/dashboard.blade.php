...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .mobile-menu-item.has-submenu .chevron {
            margin-left: auto;
            font-size: 14px;
            transition: transform 0.3s;
        }

        .mobile-menu-item.has-submenu.expanded .chevron {
            transform: rotate(90deg);
        }
        ...
        .badge-ujian, .badge-uts, .badge-uas { 
        ...
        .btn-view-all { 
            ...
            gap: 8px; 
            transition: all 0.3s; 
            box-shadow: var(--shadow-md), 0 4px 12px rgba(139,92,246,0.25); 
        }
        
        .btn-view-all:hover { 
            transform: translateY(-2px); 
            box-shadow: var(--shadow-lg), 0 8px 20px rgba(139,92,246,0.35); 
        }
...
<body>
    ...
    <div class="mobile-menu-panel" id="mobileMenuPanel">
        ...
        <div class="mobile-sidebar-menu">
            ...
            <a href="{{ route('admin.dashboard') }}" class="mobile-menu-item active"><i class="fas fa-th-large"></i><span>Dashboard</span></a>
            <a href="{{ route('admin.students') }}" class="mobile-menu-item"><i class="fas fa-user-graduate"></i><span>Data Siswa</span></a>
            <a href="{{ route('admin.teachers') }}" class="mobile-menu-item"><i class="fas fa-chalkboard-user"></i><span>Data Guru</span></a>
            ...
            <div class="mobile-submenu" id="mobileClassesSubmenu">
                <a href="{{ route('admin.classes') }}" class="mobile-submenu-item"><i class="fas fa-list"></i><span>Daftar Kelas</span></a>
                <a href="{{ route('admin.classes.create') }}" class="mobile-submenu-item"><i class="fas fa-plus-circle"></i><span>Tambah Kelas</span></a>
            </div>
    ...
    <div class="mobile-navbar" id="mobileNavbar">
        <div class="mobile-navbar-content">
            <a href="{{ route('admin.dashboard') }}" class="mobile-nav-item active"><i class="fas fa-th-large"></i><span>Dashboard</span></a>
            <a href="{{ route('admin.students') }}" class="mobile-nav-item"><i class="fas fa-user-graduate"></i><span>Siswa</span></a>
            <a href="{{ route('admin.teachers') }}" class="mobile-nav-item"><i class="fas fa-chalkboard-user"></i><span>Guru</span></a>
        ...
        <div class="calendar-wrapper">
            <div class="calendar-card">
                <div class="calendar-header">
                    <div class="calendar-month-year"><span class="calendar-month" id="currentMonth">Mei</span><span class="calendar-year" id="currentYear">2026</span></div>
    ...
    <script>
        ...
        document.querySelectorAll('.mobile-menu-item:not(.has-submenu), .mobile-submenu-item').forEach(item => {
        ...
        const typeColors = {
            'ujian': '#EF4444', 'uts': '#EF4444', 'uas': '#EF4444',
            'rapat': '#8B5CF6', 'libur': '#10B981', 'kegiatan': '#3B82F6',
            'lainnya': '#64748B'
        };
        ...
        function openModal(dateStr) {
            ...
            const dateDisplay = `${dayNames[d.getDay()]}, ${d.getDate()} ${monthNames[d.getMonth()]} ${d.getFullYear()}`;
            
            document.getElementById('modalDateTitle').textContent = dateDisplay;
                ...
                events.forEach(ev => {
                    ...
                    html += `
                        <div class="modal-event-item">
                            <div class="modal-event-icon" style="background: ${color}20; color: ${color};">
                                ${icon}
                            </div>
                            <div class="modal-event-content">
                                ...
                                <p>
                                    ...
                                    ${ev.time || 'Seharian'}
                                    ${ev.description ? `<br><small style="color: var(--text-muted);">${ev.description}</small>` : ''}
                                </p>
                            </div>
                        </div>
                    `;
            ...
            document.getElementById('modalAddAgendaBtn').href = `{{ route('admin.agendas.create') }}?date=${dateStr}`;
        ...
        function renderCalendar() {
            ...
            for (let i = 1; i <= monthLen; i++) {
                ...
                let tooltip = '';
                if (hasEvent) {
                    tooltip = `title="${eventsOnDate.length} agenda"`;
                }
                
                days += `<div class="${classes}" onclick="openModal('${dateStr}')" ${tooltip}>${i}</div>`;
            }
