...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .empty-state i { font-size: 48px; margin-bottom: 16px; opacity: 0.4; background: var(--gradient-sky); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="page-title">
                <h1><i class="fas fa-chalkboard-user"></i>Data Guru</h1>
                <p>Kelola data seluruh guru (BK & Mata Pelajaran)</p>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="teacher-info">
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($teacher->name) }}&background=3B82F6&color=fff&bold=true" class="teacher-avatar">
                            ...
                            <td style="text-align: center;">
                                <div class="action-buttons">
                                    ...
                                    <form action="{{ route('admin.teachers.delete', $teacher->id) }}" method="POST" onsubmit="return confirm('Hapus guru {{ $teacher->name }}?')" style="display: inline;">
                                        @csrf @method('DELETE')
