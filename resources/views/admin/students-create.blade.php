...
<head>
    ...
    <title>Tambah Siswa - Schoolify Modern</title>
    <!-- Font: Inter + Outfit -->
    ...
    <div class="main-content">
        <div class="page-header">
            <div class="page-header-left">
                <h1><i class="fas fa-plus-circle"></i>Tambah Siswa Baru</h1>
            </div>
        ...
        <div class="form-card">
            <div class="form-header">
                <h2><i class="fas fa-user-graduate"></i>Form Tambah Siswa</h2>
            </div>
            <div class="form-body">
                <!-- Tabs -->
                <div class="form-tabs">
                ...
                <form action="{{ route('admin.students.store') }}" method="POST">
                    ...
                    <div id="tab-account" class="tab-content active">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" class="form-control" value="{{ old('first_name') }}" placeholder="Nama depan">
                                @error('first_name')<p class="error-text">{{ $message }}</p>@enderror
                            </div>
                            <div class="form-group">
                                <label class="form-label"><i class="fas fa-user"></i> Nama Belakang</label>
                                <input type="text" name="last_name" class="form-control" value="{{ old('last_name') }}" placeholder="Nama belakang">
                            ...
                            <div class="form-group full-width">
                                ...
                                <input type="email" name="email" class="form-control" value="{{ old('email') }}" placeholder="Email siswa" required>
                    ...
                    <div id="tab-personal" class="tab-content">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="birth_place" class="form-control" value="{{ old('birth_place') }}" placeholder="Kota/Kabupaten">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Simpan Siswa</button>
                    </div>
                </form>
            </div>
        </div>
