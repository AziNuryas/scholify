...
@section('content')
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
            <div
                class="border-b border-gray-100 px-8 py-5 bg-gradient-to-r from-indigo-50/50 to-purple-50/50 flex justify-between items-center">
            ...
            <div class="divide-y divide-gray-100 max-h-[650px] overflow-y-auto">
                            ...
                            <div class="flex justify-between items-start gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 mb-2 flex-wrap">
                                        ...
                                        @if($priority == 'high')
                                            <span
                                                class="text-[9px] font-bold px-2 py-0.5 rounded bg-rose-100 text-rose-600 uppercase tracking-widest">
                                                Penting
                                            </span>
                                        @endif
                                    </div>
                ...
                @else
                    ...
                    <div class="py-16 text-center">
                        <div
                            class="w-24 h-24 bg-indigo-50 text-indigo-300 rounded-full flex items-center justify-center mx-auto mb-4 text-5xl">
                            <i class='bx bx-envelope'></i>
                        </div>
                        <p class="text-slate-800 font-bold text-xl mb-1">Tidak Ada Pengumuman</p>
                        <p class="text-sm text-slate-500 max-w-sm mx-auto">Saat ini belum ada notifikasi atau pengumuman dari
                            pihak sekolah.</p>
                    </div>
                @endif
            </div>
            ...
            <div class="mb-6 animate-fadeInUp">
                <div class="flex items-center justify-between flex-wrap gap-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1
                                class="text-2xl font-bold bg-gradient-to-r from-slate-900 via-indigo-800 to-purple-800 bg-clip-text text-transparent">
                                Pengumuman
                            </h1>
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="searchInput" placeholder="Cari judul atau isi..."
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <button data-date="all"
                                        class="date-filter-btn px-2 py-1.5 rounded-lg text-xs font-medium transition-all bg-indigo-600 text-white shadow-sm">Semua</button>
                                    <button data-date="week"
                                        class="date-filter-btn px-2 py-1.5 rounded-lg text-xs font-medium transition-all bg-slate-100 text-slate-700 hover:bg-slate-200">7
                                        Hari</button>
                                    <button data-date="month"
                                        class="date-filter-btn px-2 py-1.5 rounded-lg text-xs font-medium transition-all bg-slate-100 text-slate-700 hover:bg-slate-200">30
                                        Hari</button>
                                    <button data-date="3months"
                                        class="date-filter-btn px-2 py-1.5 rounded-lg text-xs font-medium transition-all bg-slate-100 text-slate-700 hover:bg-slate-200">3
                                        Bulan</button>
                                </div>
                            </div>
                            ...
                            <button id="resetFilter"
                                class="w-full bg-slate-100 hover:bg-slate-200 text-slate-700 py-2 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 text-xs font-semibold">
                ...
                <div class="lg:col-span-9 animate-slideInRight">
                    <div class="glass-card rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div id="announcementList"
                            class="divide-y divide-slate-100 max-h-[500px] overflow-y-auto custom-scroll"></div>

                        <!-- Empty State -->
                        <div id="emptyState" class="hidden p-8 text-center">
                            <div
                                class="w-16 h-16 mx-auto bg-gradient-to-br from-slate-100 to-slate-200 rounded-full flex items-center justify-center mb-3">
    ...
    <div id="detailModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden items-center justify-center z-50"
        onclick="closeModal()">
        <div class="bg-white rounded-xl shadow-2xl w-[500px] max-w-[90%] max-h-[80vh] overflow-hidden animate-modalPop"
            ...
            <div class="px-5 py-3 bg-slate-50 flex justify-end">
                <button onclick="closeModal()"
                    class="px-4 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm transition-all">
                    Tutup
                </button>
            </div>
        </div>
    ...
    >>>>>>> 3694a8f1ac805841019e8192c3cbf192e011cdb6
@endsection